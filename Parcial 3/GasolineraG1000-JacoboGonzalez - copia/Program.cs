class Program
{
    ...
    public void Ticket(int folio, uint numBomba, List<Empleado> listaEmpleados, int codigo, string nombreBanco, string tarjeta) {
        ...
        DateTime diaHora = DateTime.Now; System.Console.WriteLine(diaHora);
        ...
        System.Console.WriteLine("{0}              ${1}          ${2} \n", gasolina, subtotal, (subtotal * 0.16) + subtotal);
    ...
    public void CorteCaja() {
        ...
        System.Console.WriteLine("Tipo de combustible: Magna");
        ...
        System.Console.WriteLine("   8     Thiago  Chan     6      Efectivo   Efectivo {0}   {1}    ",dia);
...
public class Cotejo
{
    public Cotejo(string combustible, int idEmp, string nombre, string apellido, string tipoPago, string banco, DateTime hora, int capacidad, float importe) {
